...
def create_multi_feature_model(input_attribs):
    ...
    bilstm = layers.Bidirectional(layers.LSTM(16, kernel_regularizer=regularizers.l2(0.001)))(concate)
    # Dense1 = tf.keras.layers.Dense(100, activation='relu')(bilstm)
    # Dense2 = tf.keras.layers.Dense(50, activation='relu')(Dense1)
    Dense2 = tf.keras.layers.Dense(16, activation='relu', kernel_regularizer=regularizers.l2(0.001))(bilstm)
